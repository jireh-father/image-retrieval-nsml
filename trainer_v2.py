...
fl.DEFINE_string('nsml_eval_checkpoints', '65,69,73,82,91,100', '')
fl.DEFINE_string('nsml_eval_session', 'jireh_family/ir_ph1_v2/251', '')
...
def bind_model(saver, sess, cf):
    ...
    def infer(queries, db):
        ...
        for cp in checkpoints:
            ...
            embeddings_op = model_fn.build_model(images_ph, None, cf, is_training=False)
            ...
            nsml.load(checkpoint=cp, session=cf.nsml_eval_session)
