...
fl.DEFINE_integer('max_number_of_epochs', 80, '')
fl.DEFINE_integer('keep_checkpoint_max', 40, '')
...
fl.DEFINE_float('weight_decay', 0.0006, '')
...
fl.DEFINE_float('learning_rate', 0.0033, 'Initial learning rate.')
# fl.DEFINE_float('learning_rate', 0.000317, 'Initial learning rate.')
...
fl.DEFINE_string('nsml_session', 'jireh_family/ir_ph1_v2/260', '')
